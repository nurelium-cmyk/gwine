      ...
      <div className="container-custom relative">
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <div className="slide-in-left lg:col-span-2 order-2 lg:order-1">
            {/* Year + Name */}
            <div className="mb-8">
              <div className="flex items-baseline gap-4 pt-5 mt-5 mb-3">
          ...
          {/* Center: Wine Bottle */}
          <div className="lg:col-span-1 order-1 lg:order-2 flex justify-center px-4 md:px-0">
            <div className="relative w-64 h-40 sm:w-80 sm:h-56 md:w-96 md:h-64 lg:w-full lg:h-96 xl:h-[28rem]">
              {/* Glow */}
              <div className={`absolute inset-0 flex items-center justify-center pointer-events-none`}>
                <div className={`w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 ${wine.glowColor} rounded-full blur-3xl transition-colors duration-700`} />
              </div>
              ...
              {/* Switcher Arrows */}
              <div className="absolute -bottom-14 sm:-bottom-16 pb-2 md:-bottom-20 left-1/2 -translate-x-1/2 flex items-center gap-4 z-20">
                <button
                  onClick={prevWine}
